...
1. Azure Machine Learning 작업 영역 리소스에서 **스튜디오 시작**을 선택합니다(또는 새 브라우저 탭을 열고 [https://ml.azure.com](https://ml.azure.com?azure-portal=true)으로 이동한 후 Microsoft 계정을 사용하여 Azure Machine Learning 스튜디오에 로그인). 표시되는 오류 메시지를 기록해 두세요.
